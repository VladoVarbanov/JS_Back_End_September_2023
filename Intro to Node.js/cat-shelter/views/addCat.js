    ...
    <main>
      <form action="#" method="" class="cat-form" enctype="multipart/form-data">
        ...
        <select name="breed" id="group">
          <option value="Fluffy Cat">Norwegian Forest Cat</option>
          <option value="Fluffy Cat">British Shorthair</option>
          <option value="Fluffy Cat">Bengal</option>
          <option value="Fluffy Cat">Siamese</option>
        </select>
